    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#f4f7f9]">
            <div className="bg-white p-10 rounded-3xl shadow-[0_4px_24px_rgba(0,0,0,0.05)] w-full max-w-md border border-gray-100">
                <h1 className="text-3xl font-semibold text-center text-gray-800 mb-2">Admin Area Login</h1>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <div>
                        <div className="relative">
                            ...
                            <span className="absolute right-4 top-3 text-gray-400">
                                {/* Simple lock icon lock placeholder */}
                    ...
                    <button
                        ...
                        onClick={() => {
                            ...
                            console.log("Admin quick login credentials filled");
                        }}
